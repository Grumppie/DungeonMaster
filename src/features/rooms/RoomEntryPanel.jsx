...
export function RoomEntryPanel({
  ...
  return (
    <section className="grid gap-6">
      {sessionPreview ? (
        <Card className="border-primary/20 bg-primary/[0.04] shadow-sm" data-testid="invite-detected-card">
        ...
        <Card className="border-border/60 bg-card/95 shadow-sm">
          <CardHeader className="space-y-4">
            ...
            <CardAction>
              <Tabs
                value={roomPrivacy}
                onValueChange={onRoomPrivacyChange}
                className="w-full md:w-[220px]"
                data-testid="room-privacy-tabs"
              >
          ...
          <CardContent className="grid gap-4">
            <div className="grid gap-2">
              ...
              <Input
                ...
                data-testid="create-character-name-input"
              />
            </div>
            <div className="grid gap-2">
          ...
          <CardContent className="grid gap-4">
            <div className="grid gap-2">
              ...
              <Input
                ...
                placeholder="Bulma"
                className="h-12 rounded-2xl bg-background/70"
                data-testid="join-character-name-input"
              />
            </div>
            <div className="grid gap-2">
            ...
            <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
              {publicSessions.map((room) => (
                <button
                  ...
                  disabled={busy === "join"}
                  data-testid={`public-room-card-${room.joinCode}`}
                >
